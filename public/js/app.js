...
async function startProcessing(){
  ...
  try{
    resultCanvas=await depixelate(selectedFile,options,(stage,pct)=>setProgress(pct,stage));
    showResult();
...
function showResult(){
  resultCanvas.toBlob(blob=>{resultImg.src=URL.createObjectURL(blob);},'image/png');
  downloadBtn.onclick=()=>{const a=document.createElement('a');a.href=resultImg.src;a.download='depixelated_result.png';a.click();};
  showSection('result');
}
