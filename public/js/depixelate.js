...
// ── Cell size detection (autocorrelation) ─────────────────────────────────────
...
// ── Phase detection: find grid offset that aligns with cell boundaries ────────
...
// ── Sample cell centers and accumulate across frames ──────────────────────────
...
// ── Encode output: overlay restored region onto original video via MediaRecorder
